...
/**
 * @file ctrek_controller.h
 * @brief The class of ctrekController
 */

#ifndef MODULES_CANBUS_VEHICLE_ctrek_ctrek_CONTROLLER_H_
#define MODULES_CANBUS_VEHICLE_ctrek_ctrek_CONTROLLER_H_
...
/**
 * @class ctrekController
 *
 * @brief this class implements the vehicle controller for ctrek vehicle.
 */
class ctrekController final : public VehicleController {
 public:
  /**
   * @brief initialize the ctrek vehicle controller.
  ...
  FRIEND_TEST(ctrekControllerTest, SetDrivingMode);
  FRIEND_TEST(ctrekControllerTest, Status);
  FRIEND_TEST(ctrekControllerTest, UpdateDrivingMode);
  uint8_t getstatus();
 private:
 ...
 private:
  // control protocol
  Brake214* brake_214_ = nullptr;
  Throttle216* throttle_216_ = nullptr;
  Steering215* steering_215_ = nullptr;
  Gear217* gear_217_ = nullptr;
  Light218* light_218_ = nullptr;
...
#endif  // MODULES_CANBUS_VEHICLE_ctrek_ctrek_CONTROLLER_H_

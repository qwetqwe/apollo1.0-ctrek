...
/**
 * @file brake_321.h
 * @brief the class of Brake321 (for ctrek vehicle)
 */

#ifndef MODULES_CANBUS_VEHICLE_ctrek_PROTOCOL_BRAKE_321_H_
#define MODULES_CANBUS_VEHICLE_ctrek_PROTOCOL_BRAKE_321_H_
 ...
 */
class Brake321 : public ProtocolData {
 public:
 ...
 private:
   ...
   * 'f_type': 'valid', 'is_signed_var': False, 'physical_range': '[0|0]',
   * 'bit': 321, 'type': 'bool', 'order': 'intel', 'physical_unit': '""'}
   * @param bytes a pointer to the byte array
   * @param length the length of the byte array
...
#endif  // MODULES_CANBUS_ctrek_PROTOCOL_BRAKE_321_H_

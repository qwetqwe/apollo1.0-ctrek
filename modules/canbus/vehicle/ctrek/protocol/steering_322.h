...
/**
 * @file steering_322.h
 * @brief the class of steering_322.h (for ctrek vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_ctrek_PROTOCOL_STEERING_322_H_
#define MODULES_CANBUS_VEHICL_ctrek_PROTOCOL_STEERING_322_H_
 ...
 */
class Steering322 : public ProtocolData  {
 public:

...
namespace canbus {
namespace ctrek {
// 00000000 00000001 01000011 11111000 11111110 
TEST(Steering215Test, General) {
  uint8_t data[8] = {0x67, 0x62, 0x63, 0x64, 0x51, 0x52, 0x53, 0x54};
  Steering215 steering;
  steering.set_enable();
  steering.set_steering_angle(870);
  steering.set_steering_angle_speed(1016);
  EXPECT_EQ(steering.GetPeriod(), 10 * 1000);
  steering.UpdateData(data);
  EXPECT_EQ(data[0], 0b00000000);
  EXPECT_EQ(data[1], 0b00000001);
  EXPECT_EQ(data[2], 0b01000011);
  EXPECT_EQ(data[3], 0b11111000);
  EXPECT_EQ(data[4], 0b11111110);

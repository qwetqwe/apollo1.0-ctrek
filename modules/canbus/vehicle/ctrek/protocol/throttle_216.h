...
/**
 * @file throttle_216.h
 * @brief the class of Throttle216 (for ctrek vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_ctrek_PROTOCOL_THROTTLE_216_H_
#define MODULES_CANBUS_VEHICL_ctrek_PROTOCOL_THROTTLE_216_H_
 ...
 */
class Throttle216 : public ProtocolData {
 public:
   ...
   */
  Throttle216 *set_pedal(double pcmd);

  /**
   * @brief set enable
   * @return a this pointer to the instance itself
   */
  Throttle216 *set_enable();

  /**
   * @brief set disable
   * @return a this pointer to the instance itself
   */
  Throttle216 *set_disable();

  /**
   * @brief set enable ignore driver override
   * @return a this pointer to the instance itself
   */
  //Throttle216 *set_enable_ignore_driver_override();
...
#endif  // MODULES_CANBUS_VEHICL_ctrek_PROTOCOL_THROTTLE_216_H_
